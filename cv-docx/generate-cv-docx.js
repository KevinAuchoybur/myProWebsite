...
const DATA = {
  fr: {
    ...
    experiences: [
      {
        ...
        missions: [{
          ...
          bullets: [
            ...
            'Conception des scénarios de tests destinés à l’automatisation des parcours critiques (~80% de couverture)',
    ...
    tools: ['Squash TM', 'Selenium', 'Playwright', 'Jira', 'TypeScript', 'Agile'],
    ...
    experiences: [
      {
        ...
        missions: [{
          ...
          bullets: [
            ...
            'Designing test scenarios for critical-journey automation (~80% coverage)',
